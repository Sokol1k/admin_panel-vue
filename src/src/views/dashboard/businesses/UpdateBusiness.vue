...
export default {
  ...
  async mounted() {
    ...
    this.checkRole(this.businessShow.user_id);
    this.businessData.name = this.businessShow.name;
    this.businessData.url = this.businessShow.url;
    this.businessData.description = this.businessShow.description;
    this.businessData.category = this.businessShow.category;
    this.businessData.rating = this.businessShow.rating;
    this.businessData.rating_buildzoom = this.businessShow.rating_buildzoom;
    this.businessData.phone = this.businessShow.phone;
    this.businessData.email = this.businessShow.email;
    this.businessData.website = this.businessShow.website;
    this.businessData.is_licensed = parseInt(this.businessShow.is_licensed);
    this.businessData.license_info.type = this.businessShow.license_info.type;
    this.businessData.insured_value = this.businessShow.insured_value;
    this.businessData.bond_value = this.businessShow.bond_value;
    this.businessData.street_address = this.businessShow.street_address;
    this.businessData.city = this.businessShow.city;
    this.businessData.state = this.businessShow.state;
    this.businessData.zipcode = this.businessShow.zipcode;
    this.businessData.work_preferences.commercial = this.businessShow.work_preferences.commercial;
    this.businessData.work_preferences.residential = this.businessShow.work_preferences.residential;
    this.businessData.work_preferences.design_build = this.businessShow.work_preferences.design_build;
    this.businessData.work_preferences.institutional = this.businessShow.work_preferences.institutional;
    this.businessData.work_preferences.insurance_restoration = this.businessShow.work_preferences.insurance_restoration;
    this.imageName = this.businessShow.image;
    for (let key in this.businessShow.employee) {
      this.employee_name = key;
      this.employee_position = this.businessShow.employee[key];
      break;
    }
    this.loading = false;
  },
  ...
  methods: {
    ...
    async pushRequest() {
      ...
      data.id = this.$route.params.business;
      await this.$store.dispatch("updateBusiness", data);
      this.loading = false;
    ...
    dataAdjustment() {
      ...
      this.addData(data, "image", this.businessData.image);
    ...
    checkRole(id) {
      if (localStorage.user_role == "admin") {
        return;
      } else if (localStorage.user_id != id) {
